...
public class RabbitConfig {
    ...
    /**
     * routing key 名称
     * 此处的 routingKey 很重要，具体消息发送在该 routingKey 的
     */
     ...
     * 这是一个完整的匹配。如果一个队列绑定到该交换机上要求路由键“dog”，则只被标记为“dog”的消息才被转发，不会转发dog.guard,只会转发dog
     ...
     * 符号“#”匹配一个或多个词，符号“*”匹配不多不少一个词。因此“audit.#”能够匹配“audit.irs.corporate”，但是“audit.*”只能匹配“audit.irs”。
     */
    @Bean
